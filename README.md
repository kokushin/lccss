...
命名規則はMindBEMdingを参考にしているが、一部改変しており簡潔に記述することが可能。スタイルの打ち消しは状況に応じて可能だが、基本的に打ち消さない方が良い。また、セレクタのネストは極力行わず詳細度を一定に保つことを推奨する。
...
Version 1.2.0 / Updated date: 2017/05/23
